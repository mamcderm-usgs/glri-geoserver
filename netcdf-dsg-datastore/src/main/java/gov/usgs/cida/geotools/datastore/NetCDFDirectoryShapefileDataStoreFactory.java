 ...
 * @author tkunicki
 */
public class NetCDFDirectoryShapefileDataStoreFactory implements DataStoreFactorySpi {
     ...
     */
    public NetCDFDirectoryShapefileDataStoreFactory() { }
    ...
    public String getDisplayName() {
        return "NetCDF DSG Directory Shapefile Joining Data Store";
    }

    @Override
    public String getDescription() {
        return "Allows joining of NetCDF DSG time-series files in a directory with a Shapefile";
    }
    ...
    public DataStore createDataStore(Map<String, Serializable> params) throws IOException {
        return new NetCDFDirectoryShapefileDataStore(

 ...
 * @author tkunicki
 */
public class DbaseDirectoryShapefileDataStoreFactory implements DataStoreFactorySpi {
     ...
     */
    public DbaseDirectoryShapefileDataStoreFactory() { }
    ...
    public static final Param DBASE =
            new Param("dbase_directory", URL.class, "Dbase File Directory", true);
    ...
    public DataStore createDataStore(Map<String, Serializable> params) throws IOException {
        return new DbaseDirectoryShapefileDataStore(

 ...
 * @author tkunicki
 */
public class PRMSAnimationDirectoryShapefileDataStoreFactory implements DataStoreFactorySpi {
     ...
     */
    public PRMSAnimationDirectoryShapefileDataStoreFactory() { }
    ...
    public String getDisplayName() {
        return "PRMS Animation Directory Shapefile Joining Data Store";
    }

    @Override
    public String getDescription() {
        return "Allows joining of PRMS animation time-series files in a directory with a Shapefile";
    }
    ...
    public static final Param PRMS_ANIMATION =
            new Param("prms_animation", URL.class, "PRMS Animation File Directory", true);
        ...
        try {
            ...
            if (prmsAnimationAsURL != null) {
                ...
                try {
                    ...
                    if (!prmsAnimationAsFile.isDirectory()) {
                        return false;
                    }
                } catch (Exception ex) {
                    return false;
    ...
    public DataStore createDataStore(Map<String, Serializable> params) throws IOException {
        return new PRMSAnimationDirectoryShapefileDataStore(
